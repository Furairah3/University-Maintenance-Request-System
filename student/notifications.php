...
<title>Notifications — HostelIQ</title>
    ...
    <div class="page-body" style="max-width:820px;">
      ...
      <div class="card">
        <div class="empty-state">
          ...
          <p style="font-size:12px;">Updates about your requests will appear here.</p>
        </div>
      </div>
      <?php else: ?>
      <div class="card">
        ...
        <?php
          ...
          if (stripos($msg, 'assigned') !== false)        { $icon = '👷'; $label = 'Assigned'; }
        ...
        <div style="display:flex;gap:14px;padding:16px 20px;
          ...
          <div style="flex-shrink:0;display:flex;align-items:center;">
            <a href="?read=<?=$n['id']?>&goto=student/request_details.php?id=<?=$n['request_id']?>"
