...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'profile') {
        ...
        elseif (strlen($new) < 8) $errors['new_password'] = 'Min. 8 characters.';
...
<title>Settings — HostelIQ Admin</title>
...
<div class="layout">
  ...
  <main class="main-content">
    <div class="top-bar"><div><div class="page-title">Settings</div><div class="page-subtitle">Admin account settings</div></div></div>
        ...
        <div class="profile-info">
          ...
          <div class="profile-meta">
            ...
            <div class="profile-meta-item">
              ...
              <div class="profile-meta-value">Administrator</div>
            </div>
          </div>
        ...
        <div class="card-body">
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="<?=sanitize($user['email'])?>" disabled style="background:#f8f9fa;">
            </div>
